...
export const COLLECTIONS: Collection[] = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        price: 6.00,
        unit: "unidade",
          image: "/products/cenoura_ind1_new.jpeg",
        tags: ["Mel", "Páscoa"],
        highlight: false,
        },
        {
            id: "cacau-1",
            name: "Biscoito de Cacau",
            description: "8 Biscoitos de Cacau.",
            price: 13.00,
            unit: "kit",
            image: "/products/choco_2.png",
            tags: ["Chocolate", "Páscoa"],
            highlight: false,
        },
    {
        id: "cenoura-cri-cri",
        name: "Amendoim Cri Cri",
        description: "Cenoura de acrílico com amendoim cri cri.",
        price: 7.00,
        unit: "unidade",
        image: "/products/amend_1.png",
        tags: ["Amendoim", "Páscoa"],
        highlight: false,
    },
        {
            id: "spekulatius",
